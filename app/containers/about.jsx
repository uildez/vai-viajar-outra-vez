  ...
  return (
    <div className='flex bg-blue-600' id='sobre'>
      <div className={`relative flex lg:flex-row flex-col justify-center w-full px-8 py-12 lg:py-0 lg:px-40 gap-8 lg:gap-20`}>
        <div className='grid grid-cols-2 lg:grid-rows-2 h-auto gap-4 w-full lg:w-2/5'>
          <img className='w-full h-auto z-0' src={"/webp/about-1.webp"} alt='Foto de viagem para Las Vegas com um casal' />
          <img className='w-full h-auto z-0' src={"/webp/about-2.webp"} alt='Foto de viagem para Disney em Orlando' />
          <img className='w-full h-auto z-0' src={"/webp/about-3.webp"} alt='Foto de viagem para Noronha' />
          <img className='w-full h-auto z-0' src={"/webp/about-4.webp"} alt='Foto de viagem para Maragogi' />
        </div>
