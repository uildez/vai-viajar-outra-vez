    ...
    <div id='cupons' className='flex relative items-start min-h-[100vh] lg:min-h-[80vh] justify-start w-full mx-auto gap-4 px-8 lg:px-40 py-20 bg-yellow-600'>
      <div className='flex flex-col justify-start items-start gap-12'>
        <h2 className='text-3xl lg:text-6xl w-full lg:w-3/4 text-blue-600 font-bold font-akina uppercase'>
          Seja um membro<br className='hidden lg:flex'/> por apenas<br className='hidden lg:flex'/> R$ 29,90 /mês
        </h2>
        ...
        <a href="https://pay.hub.la/xTBEymQhnuKQaRH8INZe" target='_blank' className='w-full lg:w-fit text-center items-center justify-center px-6 py-2 text-xl bg-blue-600 text-white rounded-[10px] uppercase font-bold hover:rotate-2 hover:-translate-y-2 transition-transform duration-500'>
          Comece Agora!
        </a>
      </div>
