...
export default function Page() {
    ...
    return (
        <div className="font-redonda overflow-hidden max-w-screen min-h-screen">
            <Navbar />
            <div className="flex flex-col items-center mt-20 px-8 py-12 lg:py-0 lg:px-40 mb-20 min-h-[80vh]">
                <motion.h2
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 my-8'>
                        {cupons.map((cupom, index) => (
                            <div key={index} className='flex flex-col rounded-xl bg-blue-600 overflow-hidden'>
                                <img src={cupom.imagem} className='w-full h-[200px] object-cover' />
                                <div className='flex flex-col w-full p-8'>
                                    <h3 className='text-2xl text-white font-extrabold font-sans uppercase'>{cupom.titulo}</h3>
                                    <p className='text-2xl text-white font-redonda'>{cupom.descricao}</p>
